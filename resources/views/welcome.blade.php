        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
            <div class="container">
                ...
                <a id='blueLogo' class="d-none" href="/" class="custom-logo-link" rel="home" aria-current="page"><img
                        ...
                        alt="اسلم أيوب" sizes="(max-width: 917px) 100vw, 917px"></a>
            ...
            <div class="col-md-7 col-sm-12 pl-4 mt-1 pt-3">
                ...
                <div class="row justify-content-center">
                    <a hred="{{  asset(setting('site.section_b_cv')   )  }}" download>
                        <button class="btn  text-white p-2 m-2"> تحميل السيرة الذاتيه <i
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3">
                    <input name="name" class="form-control" type="text" placeholder="الإسم" required
                           oninvalid="this.setCustomValidity('يرجى ادخال الاسم الصحيح')">
                </div>

                <div class="col-lg-4 col-md-4  col-sm-12 mt-3">
                    <input name="email" class="form-control" type="email" placeholder="البريد الإلكتروني" required
                           oninvalid="this.setCustomValidity('يرجى ادخال البريد الالكتروني الصحيح')">
                </div>

                <div class="col-lg-4 col-md-4  col-sm-12 mt-3">
                    <input name="subject" class="form-control" type="text" placeholder="الموضوع" required
                           oninvalid="this.setCustomValidity('يرجى ادخال  الموضوع')">
                </div>

                <div class="col-sm-12 mt-3">
                    <textarea name="message" class="form-control" placeholder=" رسالتك" rows="4s" required
                              oninvalid="this.setCustomValidity('يرجى ادخال رسالتك ')"></textarea>
                </div>

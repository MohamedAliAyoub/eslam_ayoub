        ...
        <div class="row justify-content-around">
            ...
            <div class="owl-carousel" id='firstCarsual'>
                <div class="border border-white m-3 p-2">
                    <div class="text-center">
                        <img src="https://baraah.co/wp-content/uploads/2020/06/01-05.png" class="image-fluid w-50 mx-auto" >
                        <h3 class="service-title mt-3"> عنوان الخدمة</h3>
                        <h5 class="service-desc mt-3"> شرح مبسط للخدمة</h5>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-around">
            ...
            <div class="col-12 mb-3 d-flex justify-content-center categoriesBar">
                ...
                <button class="btn"> فئة أولي </button>
                <button class="btn"> فئة ثانية </button>
                <button class="btn"> فئة ثالثة </button>
                <button class="btn"> فئة رابعه </button>
            </div>

            <div class="col-12">
                <div class="owl-carousel" id="secondCarsual">
                    <div class="mb-3 position-relative" onclick="openViewModal()">

                        <div class="image position-relative overflow-hidden text-center">

                            <img src="{{asset('assets/images/portfolio-1.jpg ')}}" alt="picture 1" class="img-fluid">

                            <div class="img-card p-5 text-center w-75 m-auto position-absolute">
                                <h6 class="font-weight-bold"> أسم العمل </h6>
                                <small> فئة العمل</small>
                            </div>
    ...
    <div class="container">
        <div class="row justify-content-around">
            ...
            <div class="col-sm-12 mt-3">
                <textarea class="form-control" placeholder=" رسالتك" rows="4s"></textarea>
            </div>
...
<section class="footer py-3">
    <div class="container">
        <div class="row justify-content-between align-items-center text-center">
            ...
            <div class="col-md-3 col-12">
                <h6 class="text-white"> تم التصميم بواسطة <a href="http://www.kareem-mostafa.com/" class="designer"> Kareem Mostafa </a></h6>
            </div>
